...
//int spi2_clk, spi2_miso, spi2_mosi, spi2_cs0, spi2_reset;
#if 0
#define SET_SPI_CS  gpio_write_one_pin_value(spi2_cs0, 1, "rc522_cs0")
#define CLR_SPI_CS  gpio_write_one_pin_value(spi2_cs0, 0, "rc522_cs0")

#define SET_SPI_CK  gpio_write_one_pin_value(spi2_clk, 1, "rc522_clk")
#define CLR_SPI_CK  gpio_write_one_pin_value(spi2_clk, 0, "rc522_clk")

#define SET_SPI_MOSI  gpio_write_one_pin_value(spi2_mosi, 1, "rc522_mosi") 
#define CLR_SPI_MOSI  gpio_write_one_pin_value(spi2_mosi, 0, "rc522_mosi")

//#define STU_SPI_MISO  spi_miso
#define STU_SPI_MISO gpio_read_one_pin_value(spi2_miso, "rc522_miso") 

#define SET_RC522RST  gpio_write_one_pin_value(spi2_reset, 1, "rc522_reset")
#define CLR_RC522RST  gpio_write_one_pin_value(spi2_reset, 0, "rc522_reset")
#endif
